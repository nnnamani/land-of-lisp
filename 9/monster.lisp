...
(defun show-player ()
  (fresh-line)
  (princ "You are a vliant knight with a health of ")
  (princ *player-health*)
  (princ ", an agility of ")
...
(defmethod monster-hit ((m hydra) x)
  (decf (monster-health m) x)
  (if (monster-dead m)
      (princ "The corpse of the fully decapitated and decapacitated hydra fails to the floor!")
      (progn (princ "Your lop off ")
             (princ x)
             (princ " of the hydra's heads! "))))

(defmethod monster-attack ((m hydra))
  (let ((x (randval (ash (monster-health m) -1))))
    (princ "Ahydra attacks your with ")
    (princ x)
